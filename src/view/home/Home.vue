    ...
    >
      ...
      >
        ...
        <div class="flex flex-wrap gap-10 mt-4">
           ...
           <a href="#register"
            @click.prevent="scrollToSection('register')"
      ...
      >
        ...
        >
          ...
          <p class="text-[1rem] text-white/80 leading-[1.5]">{{ conference?.venue_name }}</p>
          <p class="text-[0.8rem] text-white/60 mt-0.5 leading-[1.4]">{{ conference?.venue_detail }}</p>
        </div>
        ...
        >
          ...
          <p class="text-[1.05rem] text-white/80 leading-[1.6]">{{ conference?.theme }}</p>
        </div>
      </div>
    </section>
