<template>
    ...
    <section id="uhosnet_group" class="my-[40px]">
        <header>
        ...
        <div class="grid grid-cols-3 grid-rows-2 align-items-center justify-items-center mt-20 mx-70 gap-20">
            <div class="w-[380px] h-[200px] border-[1.5px] border-[#b7b7b7] rounded-[15px] shadow-xl shadow-black/30
                        ...
                        hover:-translate-y-3
            ">
                <div class="logo w-[60px] h-[60px] bg-[#19528f] rounded-[10px] mx-auto mt-9 mb-4 flex items-center justify-center">
                ...
                <p class="text-center text-[#003d7e] text-[30px] font-bold">อำนวยการเครือข่าย</p>
            </div>
            <div class="w-[380px] h-[200px] border-[1.5px] border-[#b7b7b7] rounded-[15px] shadow-xl shadow-black/30
                        transition duration-300 ease-in-out
                        hover:-translate-y-3
            ">
                ...
                <p class="text-center text-[#003d7e] text-[30px] font-bold">พยาบาลเครือข่าย</p>
            </div>
            <div class="w-[380px] h-[200px] border-[1.5px] border-[#b7b7b7] rounded-[15px] shadow-xl shadow-black/30
                        transition duration-300 ease-in-out
                        hover:-translate-y-3
            ">
                ...
                <p class="text-center text-[#003d7e] text-[30px] font-bold">เภสัชกรรมเครือข่าย</p>
            </div>
            <div class="w-[380px] h-[200px] border-[1.5px] border-[#b7b7b7] rounded-[15px] shadow-xl shadow-black/30
                        transition duration-300 ease-in-out
                        hover:-translate-y-3
            ">
                <div class="logo w-[60px] h-[60px] bg-[#19528f] rounded-[10px] mx-auto mt-9 mb-4 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#e3e3e3"><path d="M653.33-160v-280H800v280H653.33Zm-246.66 0v-640h146.66v640H406.67ZM160-160v-440h146.67v440H160Z"/></svg>
                </div>
                <p class="text-center text-[#003d7e] text-[30px] font-bold">คุณภาพเครือข่าย</p>
            </div>
            <div class="w-[380px] h-[200px] border-[1.5px] border-[#b7b7b7] rounded-[15px] shadow-xl shadow-black/30
                        transition duration-300 ease-in-out
                        hover:-translate-y-3
            ">
                ...
                <p class="text-center text-[#003d7e] text-[30px] font-bold">ทรัพยากรบุคคล</p>
            </div>
            <div class="w-[380px] h-[200px] border-[1.5px] border-[#b7b7b7] rounded-[15px] shadow-xl shadow-black/30
                        transition duration-300 ease-in-out
                        hover:-translate-y-3
            ">
                ...
                <p class="text-center text-[#003d7e] text-[30px] font-bold">ระบบสารสนเทศ</p>
            </div>
        </div>
